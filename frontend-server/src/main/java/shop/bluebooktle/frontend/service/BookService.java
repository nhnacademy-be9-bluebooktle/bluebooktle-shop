...
public interface BookService {
	...
	Page<BookInfoResponse> getPagedBooks(int page, int size, String searchKeyword, BookSortType bookSortType);

	Page<BookInfoResponse> getPagedBooksByCategoryId(int page, int size, BookSortType bookSortType, Long categoryId);
