...
public class OrderController {
	...
	public ResponseEntity<JsendResponse<OrderConfirmDetailResponse>> getOrderConfirmationDetails(
		@Parameter(description = "조회할 주문의 ID") @PathVariable(name = "order-id") Long orderId,
	...
	@GetMapping("/key/{order-key}")
	public ResponseEntity<JsendResponse<OrderConfirmDetailResponse>> getOrderConfirmationDetails(
		@Parameter(description = "조회할 주문의 KEY") @PathVariable(name = "order-key") String orderKey,
		@Parameter(hidden = true) @AuthenticationPrincipal UserPrincipal userPrincipal) {
	...
	@PostMapping("/{order-key}/cancel")
	public ResponseEntity<JsendResponse<Void>> cancelOrder(
		@Parameter(description = "조회할 주문키") @PathVariable(name = "order-key") String orderKey,
		@Parameter(hidden = true) @AuthenticationPrincipal UserPrincipal userPrincipal
	) {
		if (userPrincipal == null || userPrincipal.getUserId() == null) {
