...
public enum ErrorCode {
	...
	PAYMENT_DETAIL_NOT_FOUND(HttpStatus.NOT_FOUND, "P005", "결제 상세 정보를 찾을 수 없습니다."),
	POINT_INSUFFICIENT_BALANCE(HttpStatus.BAD_REQUEST, "P006", "포인트 잔액이 부족합니다."),
	POINT_HISTORY_NOT_FOUND(HttpStatus.NOT_FOUND, "P007", "포인트 이력을 찾을 수 없습니다."),
	POINT_SOURCE_TYPE_NOT_FOUND(HttpStatus.NOT_FOUND, "P008", "포인트 발생/사용 타입을 찾을 수 없습니다."),
	PAYMENT_INVALID_AMOUNT(HttpStatus.BAD_REQUEST, "P009", "결제 금액이 유효하지 않습니다."),
	REFUND_NOT_POSSIBLE(HttpStatus.BAD_REQUEST, "P0010", "현재 상태에서는 반품/환불이 불가능합니다."),
